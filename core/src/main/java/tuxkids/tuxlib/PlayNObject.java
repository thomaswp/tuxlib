...
import tuxkids.tuxlib.HashCode.Hashable;
import tuxkids.tuxlib.layers.ImageLayerLike;
import tuxkids.tuxlib.layers.LayerLike;
...
public abstract class PlayNObject {
	...
	public static TextFormat createFormat(String fontName, float size) {
		return Cache.createFormat(fontName, size);
	}
